"""
Arynoxtech-AGI - Experimental AI Framework
A pip-installable Python library for exploring multi-agent systems and AI concepts
"""
...
description="Experimental AI framework for exploring multi-agent systems, memory, and task automation concepts.",
